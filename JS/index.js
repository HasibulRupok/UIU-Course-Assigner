...
function handleTheory(courseData, id, myCourse){
    ...
    if(courseData[4] === "08:30:AM - 10:00:AM"){
        if(myCourse.includes("08:30:AM - 10:00:AM")){
            giveAllert("Same time conflicts");
            return;
        }
        if(sisterDay.includes("08:30:AM - 10:00:AM") ){
        ...
        if(myCourse.includes("10:05:AM - 11:35:AM")){
            giveAllert("Same time conflicts");
            return;
        }
        if(sisterDay.includes("10:05:AM - 11:35:AM") ){
            giveAllert("Same time conflicts to its parallel day");
            return;
        }
    }
        ...
        if(myCourse.includes("11:40:AM - 01:10:PM")){
            giveAllert("Same time conflicts");
            return;
        }
        if(sisterDay.includes("11:40:AM - 01:10:PM") ){
            giveAllert("Same time conflicts to its parallel day");
            return;
        }
    }
        ...
        if(myCourse.includes("01:31:PM - 03:00:PM")){
            giveAllert("Same time conflicts");
            return;
        }
        if(sisterDay.includes("01:31:PM - 03:00:PM") ){
            giveAllert("Same time conflicts to its parallel day");
            return;
        }
    }
        ...
        if(myCourse.includes("03:01:PM - 04:30:PM")){
            giveAllert("Same time conflicts");
            return;
        }
        if(sisterDay.includes("03:01:PM - 04:30:PM") ){
            giveAllert("Same time conflicts to its parallel day");
            return;
        }
    }
